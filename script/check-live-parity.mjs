...
const paths = [
  ...
  ["/hub-assets/ide-release-core.mjs", "hub-assets/ide-release-core.mjs"],
  ["/downloads/hive-ide/latest.json", "downloads/hive-ide/latest.json"],
  ["/downloads/hive-ide/hive-ide-release-manifest.json", "downloads/hive-ide/hive-ide-release-manifest.json"],
